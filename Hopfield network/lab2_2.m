...
results_1_hebb = cellfun(@(img) reshape(img, 6, 6), results_1_hebb, 'UniformOutput', 0);
...
results_1_inv = cellfun(@(img) reshape(img, 6, 6), results_1_inv, 'UniformOutput', 0);
...
results_2_hebb = cellfun(@(img) reshape(img, 6, 6), results_2_hebb, 'UniformOutput', 0);
...
results_2_inv = cellfun(@(img) reshape(img, 6, 6), results_2_inv, 'UniformOutput', 0);
...
results_3_hebb = cellfun(@(img) reshape(img, 6, 6), results_3_hebb, 'UniformOutput', 0);
...
results_3_inv = cellfun(@(img) reshape(img, 6, 6), results_3_inv, 'UniformOutput', 0);
