function Solutions = HeuristicNotOptimal(Init, Final)
...
try
    ...
    cost(2) = cost(2) + 6 * sum(abs(vertcat(Blocks.ontable) - vertcat(Final.ontable)));
    cost(2) = cost(2) + 9 * sum(abs(vertcat(Blocks.clear) - vertcat(Final.clear)));
catch
    Possible=0;
end
